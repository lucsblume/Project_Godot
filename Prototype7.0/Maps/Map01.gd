...
func isTrue():
	...
	$HUD/SliderRpm2.set_visible(true)
	$HUD/SliderAngulo2.set_visible(true)
	$HUD/LabelAngle2.set_visible(true)
	$HUD/LabelRpm2.set_visible(true)
	$HUD/LifeBar2/Control.set_visible(true)
	$HUD/LifeBar2/health2.set_visible(true)
	$HUD/LifeBar2/VidaLabelChar2.set_visible(true)
	$HUD/LifeBar2/Control/ProgressBar.set_visible(true)
	$HUD/LifeBar2/Control/SpriteBar.set_visible(true)
	$HUD/Margin/HBoxContainer/Game2/stamina2.set_visible(true)
	$HUD/Margin/HBoxContainer/Game2/StaminaLabel2.set_visible(true)
	$HUD/Margin/HBoxContainer/Game2/StaminaBar2/Control/ProgressBar.set_visible(true)
	$HUD/Margin/HBoxContainer/Game2/StaminaBar2/Control/SpriteBar.set_visible(true)
	$HUD/Margin/HBoxContainer/SpriteAuxAnglo2.set_visible(true)
	$HUD/Margin/HBoxContainer/SpriteAuxRpm2.set_visible(true)
	$HUD/SliderRpm.set_visible(false)
	$HUD/SliderAngulo.set_visible(false)
	$HUD/LabelAngle1.set_visible(false)
	$HUD/LabelRpm1.set_visible(false)
	$HUD/LifeBar/Control.set_visible(false)
	$HUD/LifeBar/health.set_visible(false)
	$HUD/LifeBar/VidaLabelChar.set_visible(false)
	$HUD/LifeBar/Control/ProgressBar.set_visible(false)
	$HUD/LifeBar/Control/SpriteBar.set_visible(false)
	$HUD/Margin/HBoxContainer/Game/stamina.set_visible(false)
	$HUD/Margin/HBoxContainer/Game/StaminaLabel.set_visible(false)
	$HUD/Margin/HBoxContainer/Game/StaminaBar/Control/ProgressBar.set_visible(false)
	$HUD/Margin/HBoxContainer/Game/StaminaBar/Control/SpriteBar.set_visible(false)
	$HUD/Margin/HBoxContainer/SpriteAuxAnglo.set_visible(false)
	$HUD/Margin/HBoxContainer/SpriteAuxRpm.set_visible(false)
...
func isTrueP2():
	...
	$HUD/SliderRpm2.set_visible(false)
	$HUD/SliderAngulo2.set_visible(false)
	$HUD/LabelAngle2.set_visible(false)
	$HUD/LabelRpm2.set_visible(false)
	$HUD/LifeBar2/Control.set_visible(false)
	$HUD/LifeBar2/health2.set_visible(false)
	$HUD/LifeBar2/VidaLabelChar2.set_visible(false)
	$HUD/LifeBar2/Control/ProgressBar.set_visible(false)
	$HUD/LifeBar2/Control/SpriteBar.set_visible(false)
	$HUD/Margin/HBoxContainer/Game2/stamina2.set_visible(false)
	$HUD/Margin/HBoxContainer/Game2/StaminaLabel2.set_visible(false)
	$HUD/Margin/HBoxContainer/Game2/StaminaBar2/Control/ProgressBar.set_visible(false)
	$HUD/Margin/HBoxContainer/Game2/StaminaBar2/Control/SpriteBar.set_visible(false)
	$HUD/Margin/HBoxContainer/SpriteAuxAnglo2.set_visible(false)
	$HUD/Margin/HBoxContainer/SpriteAuxRpm2.set_visible(false)
	$HUD/SliderRpm.set_visible(true)
	$HUD/SliderAngulo.set_visible(true)
	$HUD/LabelAngle1.set_visible(true)
	$HUD/LabelRpm1.set_visible(true)
	$HUD/LifeBar/Control.set_visible(true)
	$HUD/LifeBar/health.set_visible(true)
	$HUD/LifeBar/VidaLabelChar.set_visible(true)
	$HUD/LifeBar/Control/ProgressBar.set_visible(true)
	$HUD/LifeBar/Control/SpriteBar.set_visible(true)
	$HUD/Margin/HBoxContainer/Game/stamina.set_visible(true)
	$HUD/Margin/HBoxContainer/Game/StaminaLabel.set_visible(true)
	$HUD/Margin/HBoxContainer/Game/StaminaBar/Control/ProgressBar.set_visible(true)
	$HUD/Margin/HBoxContainer/Game/StaminaBar/Control/SpriteBar.set_visible(true)
	$HUD/Margin/HBoxContainer/SpriteAuxAnglo.set_visible(true)
	$HUD/Margin/HBoxContainer/SpriteAuxRpm.set_visible(true)
